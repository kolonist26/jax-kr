...
JAX는 고성능 숫자 계산을 위해 함께 모아진 Autograd_과 XLA_입니다.

만약 신경망을 훈련시키려고 한다면, Flax_를 사용하고 그 문서부터 시작하세요.
관련 도구로는 Optax_와 Orbax_가 있습니다.
JAX를 기반으로 한 엔드-투-엔드 트랜스포머 라이브러리를 보려면 MaxText_를 확인하세요.
